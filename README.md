...
`operations.schema.json` names exactly **43 application operations** and binds
...
chat.snapshot           context_pack.build  decision.definition.disable
decision.definition.get decision.definition.list               decision.definition.publish
