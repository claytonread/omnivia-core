...
CORPUS_SHA256 = "6f4bb967fbcba58d5dab4920d4e943da4a1430862ab9a371f11fc8ec630dd0ef"
...
def test_v06_5_s5_registry_exactly_matches_catalogue(
    ...
    assert len(catalogue) == len(set(catalogue)) == 53
...
def test_v06_5_s5_candidate_head_tree_and_corpus_digest() -> None:
    ...
    assert operation["adapter_evidence_corpus"]["case_count"] * len(ADAPTERS) == 432
