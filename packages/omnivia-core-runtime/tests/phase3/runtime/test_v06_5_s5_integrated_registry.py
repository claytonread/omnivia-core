...
CORPUS_SHA256 = "a1a62f4aeefd81c60015c0197696aa6967ae36447ad86efab896b29fa945fce7"
...
def test_v06_5_s5_registry_exactly_matches_catalogue(
    ...
    assert len(catalogue) == len(set(catalogue)) == 26
...
def test_v06_5_s5_candidate_head_tree_and_corpus_digest() -> None:
    ...
    assert operation["adapter_evidence_corpus"]["case_count"] * len(ADAPTERS) == 255
