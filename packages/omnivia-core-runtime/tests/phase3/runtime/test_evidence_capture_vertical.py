...
def test_capture_writes_the_canonical_rows_and_a_conformant_result(
    ...
    # The five rows, and the identity 0041 made unique: a direct submission carries no
...
def test_a_second_principal_reuses_the_source_rather_than_forking_it(
    ...
    become two authoritative artifacts, and 0041's unique index would not stop it because
...
def test_a_fenced_write_outside_the_handler_cannot_forge_a_second_source(
    ...
    """0041's unique index is what makes the source identity a key rather than a habit."""
