...
class RuntimeJobRecovery:
    ...
    adopted: bool = False
    #: The generation the adopted claim was held at before this pass rebound it.
    #: Set only on an adoption; `None` everywhere else, including a stale claim the
    #: pass read but did not rebind.
