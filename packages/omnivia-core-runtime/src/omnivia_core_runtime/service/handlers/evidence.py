...
def _existing_direct_source(
    ...
    The predicate is the whole direct-submission identity 0037 made unique -- workspace,
    ...
    More than one row is an invariant failure rather than a caller's conflict. 0037's
...
def _append_direct_evidence(
    ...
    *,
    ...
    are NULL -- there is no locator to record and no retrieval that happened, and 0037
