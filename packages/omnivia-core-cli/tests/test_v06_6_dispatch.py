...
- **The catalogue is the source of the claims.** Every one of the forty-three
...
def test_the_two_lookups_are_declared_and_cover_all_fifty_three_paths() -> None:
...
# --------------------------------------------------------------------------
# 2 & 3. What each of the forty-three commands actually sends
# --------------------------------------------------------------------------
