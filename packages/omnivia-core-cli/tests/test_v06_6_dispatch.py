...
- **The catalogue is the source of the claims.** Every one of the twenty-seven
...
# --------------------------------------------------------------------------
# 2 & 3. What each of the twenty-seven commands actually sends
# --------------------------------------------------------------------------
