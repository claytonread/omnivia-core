...
- **The catalogue is the source of the claims.** Every one of the twenty-eight
...
def test_the_two_lookups_are_declared_and_cover_all_thirty_one_paths() -> None:
...
# --------------------------------------------------------------------------
# 2 & 3. What each of the twenty-eight commands actually sends
# --------------------------------------------------------------------------
