...
*Bijection with the catalogue.* The twenty-six application commands map onto the
twenty-six operations of `OPERATION_CATALOGUE`, one to one, checked at import. A
...
APPLICATION_COMMANDS: Final[tuple[ApplicationCommand, ...]] = (
    ...
    ApplicationCommand(("workflow", "start"), "workflow.start", "workflow_run"),
    ApplicationCommand(
    ...
    ApplicationCommand(("workflow", "review"), "workflow.review", "workflow_review"),
)
