...
*Bijection with the catalogue.* The twenty-two application commands map onto the
twenty-two operations of `OPERATION_CATALOGUE`, one to one, checked at import. A
