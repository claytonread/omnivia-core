...
**Integration branch:** `codex/core-capture-quality-m1`

**Integration base:** `6f11be4ba7f935ac506f16b0f82ba84c45b0648a`
...
| G2 capture and storage | handler, section 13 capture acceptance, identity migration, blob primitive, projection lifecycle | `.venv/bin/python -m pytest packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py packages/omnivia-core-runtime/tests/phase3/runtime/test_blob_publication.py packages/omnivia-core-runtime/tests/phase3/runtime/test_fts_projection_lifecycle.py -q` |
...
| R3 | Source identity -- exact claims reuse, disagreement is canonical `conflict`, database uniqueness for new direct submissions | `packages/omnivia-core-runtime/src/omnivia_core_runtime/storage/migration_files/0041_evidence_source_identity.sql`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/handlers/evidence.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_an_exact_resubmission_reuses_the_source_and_a_changed_claim_conflicts`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_index_key_is_the_whole_source_identity_tuple`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_refuses_a_repeated_identity_whose_nullable_members_are_null` | AUTO | green |
...
| R5 | Setup, grants and migration -- restricted default, explicit enable, redacted status, confirmed revoke, no ambient grant | `packages/omnivia-core-cli/src/omnivia_core_cli/mcp_admin.py`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/installed_mcp.py`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/storage/installation_store.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/configuration.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` | `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_a_first_configure_publishes_both_halves_and_prints_a_snippet`, `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_an_unrepresentable_codex_path_is_refused_before_authority_changes`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_authority.py::test_stored_rights_are_exactly_the_profile_and_never_a_wildcard`, `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_legacy_startup_without_prior_setup_refuses_without_creating_authority`, `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_one_interrupted_restricted_setup_is_published_without_grant_change`, `packages/omnivia-core-mcp/tests/test_mcp_installed_verification.py::test_a_legacy_configuration_is_upgraded_to_restricted_before_qualification` | AUTO | green |
...
|---|---|---|---|---|
| A-1 A fresh or upgraded default installation advertises exactly ten restricted tools | `packages/omnivia-core-mcp/src/omnivia_core_mcp/manifest.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/configuration.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` | `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_the_two_profiles_are_exactly_ten_and_fifteen_tools`, `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_restricted_is_the_safe_default_for_a_caller_that_names_no_profile`, `packages/omnivia-core-mcp/tests/test_mcp_installed_verification.py::test_a_legacy_configuration_is_upgraded_to_restricted_before_qualification`, `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_the_ceiling_alone_leaves_the_server_restricted_over_the_wire` | AUTO | green |
| A-2 An explicitly configured authoring installation advertises exactly fifteen tools | `packages/omnivia-core-mcp/src/omnivia_core_mcp/manifest.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` | `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_the_authoring_profile_is_the_restricted_ten_plus_five`, `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_an_admitted_authoring_session_lists_fifteen_and_calls_every_new_tool`, `packages/omnivia-core-mcp/tests/test_mcp_installed_verification.py::test_an_authoring_inventory_qualifies_and_reports_fifteen_tools` | AUTO | green |
| A-3 Every excluded catalogue mutation remains unadvertised and undispatchable | `packages/omnivia-core-mcp/src/omnivia_core_mcp/manifest.py` | `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_every_catalogue_operation_outside_the_fifteen_is_unreachable`, `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_an_unreviewed_mutating_operation_cannot_be_admitted`, `packages/omnivia-core-mcp/tests/test_mcp_exposure_manifest.py::test_no_service_lifecycle_operation_is_exposed`, `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_a_name_absent_from_the_manifest_is_not_callable` | AUTO | green |
...
| B-2 Confirm fifteen tools are visible | listing compared with `exposure_manifest("authoring")`, lines 426-429 | `packages/omnivia-core-mcp/tests/test_mcp_standalone_authoring_acceptance.py::test_the_standalone_authoring_journey_runs_on_an_empty_workspace` | AUTO | green |
...
| C-14 Same source id in different workspaces stays distinct | `packages/omnivia-core-runtime/src/omnivia_core_runtime/storage/migration_files/0041_evidence_source_identity.sql`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/handlers/evidence.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_keeps_genuinely_different_identities_apart`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_the_same_source_id_in_two_workspaces_is_two_independent_artifacts` | AUTO | green |
| C-15 Legacy duplicate invariant failure | migration fails closed over colliding rows; the handler refuses a non-unique lookup with `internal_non_recoverable` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_refuses_to_apply_over_colliding_legacy_rows`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_source_identity_naming_two_artifacts_fails_closed_and_writes_nothing`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_a_fenced_write_outside_the_handler_cannot_forge_a_second_source` | AUTO | green |
| C-16 Inert content carrying a URL, a local path and reserved-looking JSON keys | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/handlers/evidence.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_hostile_content_reaches_no_filesystem_network_process_or_authority_seam`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_hostile_looking_content_is_a_document_and_nothing_else`, `packages/omnivia-core-mcp/tests/test_mcp_standalone_authoring_acceptance.py::test_the_standalone_authoring_journey_runs_on_an_empty_workspace` | AUTO | green |
...
| C-18 Each success asserts blob checksum, L0 disposition, exact source tuple, audit attribution, idempotency settlement and lexical retrievability | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/handlers/evidence.py`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/mutation.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[plain]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[markdown]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[base64]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[utf8-multibyte]` | AUTO | green |

What closed the four rows above, all of it in
`packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py`:

- **C-14** now drives two separately created, separately migrated, separately
  leased workspaces through the production capture path under one source id, and
  asserts two artifacts, two blobs under two roots, and retrieval that answers
  only from the workspace it was asked in. The index-level neighbour stays cited
  beside it, because the two say different things.
- **C-15** reaches the handler's own `len(rows) != 1` refusal on a workspace
  built one migration short of `0041`, which is the state an installation that
  never upgraded is in and the only state that branch exists for. The catalogue
  is narrowed for that workspace's construction and restored immediately, so the
  invariant is unweakened everywhere it is applied, and the migration's own
  fail-closed test is unchanged.
- **C-16** now records every `open`, `os.open`, `socket`, `subprocess.Popen`,
  `os.system` and `urlopen` a capture of hostile content makes, and the grant it
  issues. The recorders delegate rather than replace, so what changes is that the
  run is observed. The path named inside the document is a file that really
  exists and really holds bytes, and it is never opened. The state-based
  neighbour stays cited: it says what the workspace looks like afterwards, which
  instrumentation does not.
- **C-18** asserts the whole settlement for every content and media form C-1 and
  C-2 require, including the audit row read back by `principal_id`, `operation`,
  `purpose`, `outcome_class` and recorded authority, the claim's digest against
  the contract's own `idempotency_equivalence`, and the replay answering under
  the same audit reference.
...
| E-5 Absent, expired, reused or already-spent grant | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/mutation.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_capture_without_a_usable_grant_is_denied_and_writes_nothing[absent]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_capture_without_a_usable_grant_is_denied_and_writes_nothing[expired]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_grant_re_presented_after_it_was_spent_is_refused[executing]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_grant_re_presented_after_it_was_spent_is_refused[replaying]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_v06_5_s0_mutation_foundation.py::test_v06_5_s0_server_issued_grant_required`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_v06_5_s0_mutation_foundation.py::test_v06_5_s0_grant_is_bound_to_canonical_request`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_v06_5_s0_mutation_foundation.py::test_v06_5_s2_replay_expiry_after_execution_write_rolls_back_grant_spend` | AUTO | green |
...
| E-11 Idempotency conflict | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/mutation.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_a_same_key_replay_is_answered_and_a_changed_body_conflicts`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_a_parent_text_fingerprint_replays_after_capture_canonicalization`, `packages/omnivia-core-mcp/tests/test_mcp_standalone_authoring_acceptance.py::test_the_standalone_authoring_journey_runs_on_an_empty_workspace`, `packages/omnivia-core-mcp/tests/test_mcp_import_job_acceptance.py::test_a_staged_import_is_executed_observed_and_survives_revocation` | AUTO | green |
...
| E-13 Service-fence loss | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/mutation.py`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/ownership/fencing.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_capture_whose_fence_moves_mid_flight_settles_nothing[after_the_domain_write]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_capture_whose_fence_moves_mid_flight_settles_nothing[after_the_last_settlement_write]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_a_service_instance_that_lost_the_workspace_cannot_capture_into_it`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_authority.py::test_a_stale_installation_authority_cannot_write`, `packages/omnivia-core-mcp/tests/test_mcp_architecture_gates.py::test_architecture_gate_clients_never_own_workspace_lease` | AUTO | green |
...
What closed the two rows above:

- **E-5** now has four dedicated capture-path cases: no grant at all, an honestly
  issued grant already outside its window, the grant a completed capture spent
  re-presented, and the grant an honest replay spent re-presented. Each is
  refused with `authorization_denied`, writes nothing into any of the nine
  durable tables, leaves the grant recorded exactly once, and is followed by a
  same-key call that still settles -- so the refusal withheld the mutation rather
  than consuming the key.
- **E-13** now injects fence loss inside the capture transaction at both layers
  that enforce it -- the persisted guard triggers, which refuse the next durable
  write after the evidence rows, and `fenced_transaction`'s revalidation
  immediately before COMMIT -- and separately supersedes the service instance by
  a real successor lease and guard. In every case the whole transaction rolls
  back, no idempotency claim survives to answer a later replay, and the refusal
  carries neither the submitted document nor the workspace path.
...
| F-5 Concurrent identical calls | `packages/omnivia-core-runtime/src/omnivia_core_runtime/storage/migration_files/0041_evidence_source_identity.sql`, `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/transport.py` | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_two_concurrent_identical_captures_produce_one_durable_effect`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_a_fenced_write_outside_the_handler_cannot_forge_a_second_source`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_refuses_the_repeat_in_a_live_guarded_workspace` | AUTO | green |
| F-6 Timeout or connection loss after possible dispatch | `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` -- no automatic retry, no new key | `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_a_lost_capture_response_replays_after_a_real_service_restart`, `packages/omnivia-core-mcp/tests/test_mcp_server_authority.py::test_a_same_key_replay_is_a_real_call_every_time`, `packages/omnivia-core-mcp/tests/test_mcp_server_authority.py::test_a_client_failure_becomes_a_readable_tool_error` | AUTO | green |
...
| F-8 Same-key recovery from a new MCP session | `packages/omnivia-core-runtime/src/omnivia_core_runtime/service/mutation.py` | `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_a_lost_capture_response_replays_after_a_real_service_restart`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_local_control.py::test_revocation_blocks_the_next_call_and_the_same_key_replay` | AUTO | green |
...
- **F-1** now enumerates the four durable steps a capture consists of -- blob
  ...
  audit, claim, outcome and execution settlement, and the projection barrier --
  and injects a fault at each. The first three are inside or before the one
  transaction, so each leaves all nine durable tables empty and no transaction
  open; the fourth runs after that commit, so the evidence stands, the search
  refuses rather than reporting "not found", and the same key repairs it. Every
  case then asserts the same recovery: one artifact, one provenance event, one
  audit event, one claim, one terminal outcome, one searchable artifact, and a
  second recovery attempt that replays rather than accumulating. The
  `memory.create` and `import.start` halves are the existing dedicated fault
  suites, cited in the row rather than copied.
- **F-5** now issues two identical calls from two client connections, both
  established before either speaks, into a real `LocalSocketServer` in front of
  the production dispatcher. That is what a caller can arrange against this
  build: the service holds one writable connection and serves one connection at
  a time, so the requirement is one durable effect and one canonical answer
...
The former F-2/F-6/F-8 source-tree shortfall is now one executable boundary test.
The first MCP process authenticates with the installed principal and waits until
the real transport has decoded Core's success, then its test-only fault wrapper
hard-kills that exact service and raises instead of returning the response to
MCP. With the service offline, the test reads the canonical settled result from
the idempotency outcome. It then runs the installed managed-start command,
asserts a different process, service instance and fencing generation, opens a
fresh production MCP entry point with protected authoring admission, and replays
the original key and input. The returned result equals the stored canonical JSON,
search finds that artifact, and offline counts prove one artifact, blob, claim and
outcome.
...
| G-2 Legacy `mutation_enabled: false` migrates to restricted without widening | `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` only finishes publication for one already-active restricted setup with recoverable material; it never creates authority; the installation migration chain carries every grant row across unchanged | `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_legacy_startup_without_prior_setup_refuses_without_creating_authority`, `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_one_interrupted_restricted_setup_is_published_without_grant_change`, `packages/omnivia-core-mcp/tests/test_mcp_installed_verification.py::test_a_legacy_configuration_is_upgraded_to_restricted_before_qualification`, `packages/omnivia-core-mcp/tests/test_mcp_configuration.py::test_mutation_enabled_false_or_absent_is_restricted_whatever_admission_says`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_authority_migration.py::test_0003_carries_every_version_two_grant_row_across_unchanged`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_authority_migration.py::test_clean_version_one_catalogue_upgrades_to_the_head` | AUTO | green |
| G-3 Legacy `mutation_enabled: true` requires explicit confirmation and never silently activates authoring | `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` either refuses for explicit setup or discards the legacy ceiling while completing an existing restricted publication; credential-bearing ceilings and protected admission remain independent | `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_legacy_startup_without_prior_setup_refuses_without_creating_authority`, `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_one_interrupted_restricted_setup_is_published_without_grant_change`, `packages/omnivia-core-mcp/tests/test_mcp_installed_verification.py::test_a_legacy_configuration_is_upgraded_to_restricted_before_qualification`, `packages/omnivia-core-mcp/tests/test_mcp_configuration.py::test_mutation_enabled_true_alone_is_still_restricted`, `packages/omnivia-core-mcp/tests/test_mcp_server_authority.py::test_public_intent_alone_never_reaches_a_mutation_tool`, `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_the_ceiling_alone_leaves_the_server_restricted_over_the_wire` | AUTO | green |
...
| G-5 Interrupted configure either rolls back or reports a safe resumable state | `packages/omnivia-core-cli/src/omnivia_core_cli/mcp_admin.py`, `packages/omnivia-core-mcp/src/omnivia_core_mcp/server.py` | `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_configuration_publication_failure_preserves_existing_authority_and_bearer`, `packages/omnivia-core-mcp/tests/test_mcp_legacy_upgrade.py::test_readback_must_match_the_whole_published_authority`, `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_a_failed_handshake_revokes_the_authority_and_removes_the_local_half`, `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_a_failed_handshake_whose_revocation_also_fails_reports_a_recoverable_state`, `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_a_credential_write_failure_revokes_before_it_discards`, `packages/omnivia-core-cli/tests/test_mcp_administration.py::test_a_configuration_write_failure_revokes_before_it_discards` | AUTO | green |
...
| S-5 Oversized input, base64 and resource-exhaustion review | An encoded-length ceiling is applied before `b64decode` allocates, so a hostile encoded payload is refused without being decoded; the decoded bound is 1..1048576 inclusive; MCP scans text only to that bound, replaces an already-classified oversized body with one fixed bounded sentinel, and leaves Core to return the canonical error without attempting to serialize the caller's body through OVC1; the configuration reader is bounded at 64 KiB with a bounded read; `job_events` pages are bounded at 1,000 events by the projected contract; the local control frame is bounded before buffering. | `tests/contracts/test_semantics_evidence_capture.py::test_encoded_oversize_content_base64_is_rejected_before_decoding`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_capture_admits_one_mebibyte_and_refuses_the_byte_after_it`, `packages/omnivia-core-mcp/tests/test_mcp_server_authority.py::test_capture_size_refusal_is_classified_by_core_and_relayed_by_mcp`, `packages/omnivia-core-mcp/tests/test_mcp_configuration.py::test_the_byte_limit_is_checked_with_a_bounded_read`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_local_control.py::test_an_oversized_control_is_refused_before_it_is_buffered` | AUTO | green |
| S-6 SQL uniqueness and concurrency review | Direct-submission identity is enforced by a unique index over the whole five-member tuple, with `COALESCE(..., X'00')` standing in for the two nullable members; SQLite's storage-class ordering and migration `0008`'s type checks together make the sentinel uncollidable with any admissible value. The migration carries no DML and fails closed over colliding legacy rows, leaving the workspace at `0040`. Installation grant rows are append-only, with UPDATE and DELETE aborted by trigger. Concurrency at the service is one writable connection and one connection served at a time, so two identical calls arriving together settle once and answer identically. | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_index_key_is_the_whole_source_identity_tuple`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_refuses_a_repeated_identity_whose_nullable_members_are_null`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_refuses_to_apply_over_colliding_legacy_rows`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_source_identity_migration.py::test_0041_adds_one_index_and_touches_nothing_else`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_two_concurrent_identical_captures_produce_one_durable_effect` | AUTO | green |
| S-7 Log, audit, exception and status redaction review | Every refusal is a fixed payload-free sentence: no path, workspace, bearer, reference, service envelope or answer body. Submitted text never reaches a refusal or an audit row, and a capture's audit row carries the authenticated principal, the catalogue operation, the declared purpose and the contract's own authority statement -- three members, none of which a credential or a grant could travel in. The capture handler uses sentinel-then-raise so the contract's payload-quoting error is not reachable through `__context__`. Status is the durable state and only the durable state. Logging is stderr-only and stdout is protocol-only, under `redirect_stdout`. | `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[plain]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_acceptance.py::test_each_accepted_form_settles_with_a_complete_and_attributable_record[base64]`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_evidence_capture_vertical.py::test_no_refusal_or_audit_record_carries_the_submitted_text`, `packages/omnivia-core-mcp/tests/test_mcp_server_authority.py::test_a_contract_refusal_repeats_nothing_of_what_was_sent`, `packages/omnivia-core-mcp/tests/test_mcp_stdio_end_to_end.py::test_every_byte_the_server_writes_to_stdout_is_valid_protocol`, `packages/omnivia-core-runtime/tests/phase3/runtime/test_installed_mcp_authority.py::test_lifecycle_evidence_is_recorded_without_credential_material` | AUTO | green |
...
What closed the two review rows that were `partial`:

- **S-6**'s concurrency half now runs two identical calls from two connections
  into a real local socket in front of the production dispatcher, which is the
  same evidence F-5 records. The review's own conclusion is unchanged: this build
  serializes, so the property under test is that two callers arriving together
  produce one durable effect rather than that two writers interleave safely.
- **S-7** now reads a capture's audit row back -- `principal_id`, `operation`,
  `purpose`, `outcome_class`, `error_code` and the recorded authority's exact
  member set -- for every accepted content and media form, which is the same
  evidence C-18 records.
