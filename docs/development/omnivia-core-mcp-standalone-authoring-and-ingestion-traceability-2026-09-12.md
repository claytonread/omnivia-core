...
- **C-15** reaches the handler's own `len(rows) != 1` refusal on a workspace
  built one migration short of `0037`, which is the state an installation that
