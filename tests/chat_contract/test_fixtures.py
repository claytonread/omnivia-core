"""Fixture conformance for the 159 governed Chat Runtime Contract v1 fixtures.
...
def test_the_manifest_declares_the_governed_counts() -> None:
    assert MANIFEST["counts"] == {"total": 159, "valid": 76, "invalid": 83}
    assert len(MANIFEST["fixtures"]) == 159
