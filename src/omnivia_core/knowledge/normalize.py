...
# `omnivia_memory.knowledge.normalize` and tests/canonical_migration/test_parity.py
...
# import statement's exact name order must survive verbatim. Comments are the only
