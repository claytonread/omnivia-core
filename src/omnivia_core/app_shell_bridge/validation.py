...
# `typing.Dict`/`typing.List` spellings verbatim; do not let pyupgrade
# modernize them.
...
def _check_required_strings(
    data: Dict[str, Any],
    field_names: tuple,  # type: ignore[type-arg]
    errors: List[str],
) -> None:
...
def _build_sources(sources_raw: Any) -> list:  # type: ignore[type-arg]
