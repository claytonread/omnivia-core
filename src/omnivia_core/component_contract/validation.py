...
# ruff: noqa: I001, PIE790, UP006, UP035, UP045 -- canonical port preserves the
# legacy source's exact import placement, `typing.Dict`/`List`/`Optional`
# spellings, and `pass` statement verbatim; do not let isort/pyupgrade
# modernize them.
