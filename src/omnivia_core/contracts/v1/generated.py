...
CONTRACT_VERSION_PATTERN: Final = '^(0|[1-9][0-9]*)\\.(0|[1-9][0-9]*)$(?![\\s\\S])'
...
REQUEST_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
CORRELATION_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
TRACE_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
WORKSPACE_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
AUDIT_REFERENCE_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
IDENTIFIER_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
CAPABILITY_ID_PATTERN: Final = (
    '^[a-z][a-z0-9]*(?:[_-][a-z0-9]+)*(?:\\.[a-z'
    '][a-z0-9]*(?:[_-][a-z0-9]+)*)+$(?![\\s\\S])'
)
OPEN_CODE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
SCOPE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:[.:][a-z][a-z0-9_]*)*$(?![\\s\\S])'
PURPOSE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
OPAQUE_TOKEN_PATTERN: Final = '^[!-~]+$(?![\\s\\S])'
IDEMPOTENCY_KEY_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
TIMESTAMP_PATTERN: Final = (
    '^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]'
    '{2}:[0-9]{2}(?:\\.[0-9]{1,9})?Z$(?![\\s\\S])'
)
PROJECTION_VERSION_PATTERN: Final = '^[!-~]+$(?![\\s\\S])'
OPERATION_COMPATIBILITY_STATE_PATTERN: Final = (
    '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
)
QUALIFICATION_STATE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
COMPONENT_KIND_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
CONTEXT_PACK_MODE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
CONTEXT_PACK_DIGEST_PATTERN: Final = '^sha256:[0-9a-f]{64}$(?![\\s\\S])'
OPERATION_NAME_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)+$(?![\\s\\S])'
ERROR_CODE_PATTERN: Final = '^[a-z][a-z0-9_]*$(?![\\s\\S])'
RETRY_CLASS_PATTERN: Final = '^[a-z][a-z0-9_]*$(?![\\s\\S])'
EVIDENCE_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
EVIDENCE_CHECKSUM_PATTERN: Final = '^[a-z][a-z0-9_]*:[A-Za-z0-9+/=_-]+$(?![\\s\\S])'
MEDIA_TYPE_PATTERN: Final = (
    '^[A-Za-z0-9][A-Za-z0-9!#$&^_.+-]*/[A-Za'
    '-z0-9][A-Za-z0-9!#$&^_.+-]*$(?![\\s\\S])'
)
GRAPH_DIRECTION_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
GRAPH_RELATION_TYPE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
GRAPH_ORDERING_BASIS_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
GRAPH_BOUNDARY_REASON_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
JOB_STATE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
JOB_PROGRESS_UNIT_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
JOB_CANCELLATION_AVAILABILITY_PATTERN: Final = (
    '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
)
JOB_RECOVERY_AVAILABILITY_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
JOB_CANCELLATION_DISPOSITION_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
JOB_RECOVERY_DISPOSITION_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
CONTENT_CHECKSUM_PATTERN: Final = '^sha256:[0-9a-f]{64}$(?![\\s\\S])'
GOVERNED_RECORD_TYPE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
GOVERNED_RECORD_VIEW_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
RECORD_DOMAIN_SCOPE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
MEMORY_SEARCH_ORDER_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
OPERATION_SIDE_EFFECT_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
OPERATION_SCOPE_KIND_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
OPERATION_COMPLETION_MODE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
RECORD_ID_PATTERN: Final = '^[A-Za-z0-9][A-Za-z0-9._:-]*$(?![\\s\\S])'
RECORD_VERSION_PATTERN: Final = '^[!-~]+$(?![\\s\\S])'
GOVERNANCE_LAYER_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
RECORD_CURRENTNESS_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
GOVERNANCE_STATE_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
SOURCE_KIND_PATTERN: Final = '^[a-z][a-z0-9_]*(?:\\.[a-z][a-z0-9_]*)*$(?![\\s\\S])'
